...
Andiora default fonts and fontconfig. Ships Cascadia Code, Noto Sans/Serif, Nerd Fonts Symbols, and Twemoji (COLRv1). Uses fontconfig to handle language-specific CJK/Thai/Arabic selection and emoji fallback.
...
This package is a collection of independently licensed works. Andiora
...
same information at `/usr/share/doc/andiora-fonts/copyright` together with
